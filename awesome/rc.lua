...
awful.rules.rules = {
  ...
  -- how to navigate with tags?
    -- { rule = { class = {terminal,"google-chrome"} },
    --   properties = { screen = 1, tag = "1", maximized_horizontal = true, } },
    -- { rule = { class = "google-chrome"},
    --   properties = { maximized= true, screen = 1, tag = "2" } },
    -- { rule = { class = terminal},
    --   properties = { maximized= true, screen = 1, tag = "3" } },
}
-- }}}
...
local collect_the_garb = function()
  collectgarbage()
